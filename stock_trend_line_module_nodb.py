...
def stock_trend_line_db_store(db_file_path, get_db_name, stock_price_candle_cnt):
    ...
    for table_name in total_table_name:
        ...
        plt.axhline(poly_sell_max_price, color='red', linestyle='-', linewidth=1)
        plt.axhline(poly_buy_min_price, color='blue', linestyle='-', linewidth=1)
        # plt.axhline(futrue_s_run_price, color='violet', linestyle=':', linewidth=2)
